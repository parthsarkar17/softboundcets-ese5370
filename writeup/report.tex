...
\section{The Attack}
    ...
    \subsection{Relevant Background}
      ...
      *(array1_alias + 4) = RANDOM_INTEGER;
            ...
            (\verb|RANDOM_INTEGER = 37|). The directory with the code
...
\section{Encryption}
    ...
    it and not be able to use or modify it.
    ...
    \subsection{Exclusive OR (XOR) Encrypted Table}
        ...
        benchmarking performance, and the hard-coded value suffices here.
    ...
    \subsection{Results \& Evaluation}
        ...
        \subsubsection{Performance Overhead}
            ...
            The benchmark I used was the \href{https://github.com/parthsarkar17/softboundcets-ese5370/blob/aes-encryption/ansibench/linpack/src/linpack.c}{LINPACK}
            ...
            the linear system $Ax = b$ using this factorization. While my benchmark
            is not the diverse and varied set a real benchmark suite should
            aim to be, I did indeed discover a noticeable AES performance overhead
