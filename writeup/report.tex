...
\section{Dataflow Optimization: Eliding Stack Dereference Checks}
    ...
    At a high level, my optimization proves that type-aware dereferences for constant-offset 
    pointers into stack memory can be elided. This is valuable for fixed-size
    arrays and stack-allocated structs, which are relatively common progrmaming patterns.
    ...
    at each basic block. If the variable is a pointer variable, either we:
    ...
    \subsection{Intraprocedural Dataflow Theory}
        ...
        analysis, constant propagation). Instead, it seemed to be an amalgamation
        ...
        regarding the termination of my analysis and whether I would achieve any
        meaningful results.
